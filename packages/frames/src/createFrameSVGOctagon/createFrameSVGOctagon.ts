...
type CreateFrameSVGOctagonProps = {
  styled?: boolean
  leftTop?: boolean
  rightTop?: boolean
  rightBottom?: boolean
...
const defaultProps: Required<CreateFrameSVGOctagonProps> = {
  styled: true,
  leftTop: true,
  rightTop: true,
  rightBottom: true,
...
export type { CreateFrameSVGOctagonProps }
export { createFrameSVGOctagon }
